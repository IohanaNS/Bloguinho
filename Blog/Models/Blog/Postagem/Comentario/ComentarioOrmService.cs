...
namespace Blog.Models.Blog.Postagem.Comentario
{
    public class ComentarioOrmService
    {
        ...
        public List<ComentarioEntity> ObterComentarios()
        {
            ...
            var comentariosESuaPostagens = _databaseContext.Comentarios
        ...
        public List<ComentarioEntity> PesquisarComentarioPorNome(string texto)
        {
            return _databaseContext.Comentarios.Where(c => c.Texto.Contains(texto)).ToList();
